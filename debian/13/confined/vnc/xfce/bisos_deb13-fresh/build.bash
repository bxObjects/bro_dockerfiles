#!/bin/bash
#
# Build the deb13 confined (bisos_deb13-fresh) image with docker.
#
...
# leaves' Dockerfiles say "FROM bisos_deb13-fresh:latest" and this leaf's
# docker-compose.yml says "image: bisos_deb13-fresh:latest", so this name is
# what makes both the bash path and the .spcs path interoperate.
LOCAL_IMAGE="bisos_deb13-fresh"
LOCAL_TAG="latest"

# --- DockerHub name ---------------------------------------------------------
# Used ONLY by -u (upload). Irrelevant to a local build.
DOCKER_HUB_USER="bisos"
HUB_IMAGE="deb13-fresh-vnc-xfce"
HUB_TAG="4"
