#!/bin/bash
#
# Build the deb13 privileged (bisos_deb13-sysd) image with docker.
#
...
# "image: bisos_deb13-sysd:latest", so this name is what makes the bash path
# and the .spcs path interoperate.
LOCAL_IMAGE="bisos_deb13-sysd"
LOCAL_TAG="latest"
...
BASE_LEAF="../../../../confined/vnc/xfce/bisos_deb13-fresh"

# --- DockerHub name ---------------------------------------------------------
# Used ONLY by -u (upload). Irrelevant to a local build.
DOCKER_HUB_USER="bisos"
HUB_IMAGE="deb13-sysd-vnc-xfce"
HUB_TAG="1"
